...
async function create(req, res) {
  ...
  res.status(201).json({ data: { ...data, reservation_date: formatDate(data.reservation_date) } });
}
...
async function update(req, res) {
  ...
  res.status(200).json({ data: { ...data, reservation_date: formatDate(data.reservation_date) } });
}
